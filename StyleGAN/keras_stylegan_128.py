...
Source: https://keras.io/examples/generative/stylegan/
"""
...
ds_train = keras.preprocessing.image_dataset_from_directory(
    PIC_DIR, label_mode=None, image_size=(128, 128), batch_size=32
)
...
def plot_images(images, log2_res, fname=""):
    ...
    grid_col = 4  # min(images.shape[0], int(32 // scale))
    grid_row = 4  # 1
...
class StyleGAN(tf.keras.Model):
    def __init__(self, z_dim=512, target_res=128, start_res=4):
    ...
    def compile(self, steps_per_epoch, phase, res, d_optimizer, g_optimizer, *args, **kwargs):
...
Note: 'step_per_epoch' needs to be at least 10000 to get decent results
"""
train(start_res=4, target_res=128, steps_per_epoch=10000, display_images=True)